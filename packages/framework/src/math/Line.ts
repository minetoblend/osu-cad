...
export class Line
{
  ...
  public closestPoint(position: Vec2)
  {
    return Line.closestPoint(this.startPoint, this.endPoint, position);
  }

  public static closestPoint(startPoint: Vec2, endPoint: Vec2, position: Vec2)
  {
  ...
  public static distanceSq(startPoint: Vec2, endPoint: Vec2, position: Vec2)
  {
    return this.closestPoint(startPoint, endPoint, position).distanceSq(position);
  }

  public static distance(startPoint: Vec2, endPoint: Vec2, position: Vec2)
  {
  ...
  public get directionNormalized()
  {
    return this.direction.normalize();
  }

  public get orthogonalDirection()
  {
    const dir = this.directionNormalized;
    return new Vec2(-dir.y, dir.x);
  }

  public distance(p: Vec2)
  {
