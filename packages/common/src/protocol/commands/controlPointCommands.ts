...
export const CreateControlPointHandler: CommandHandler<CreateControlPointCommand> = {
  ...
  createUndo(command: CreateControlPointCommand, context: CommandContext): EditorCommand | undefined {
...
export const DeleteControlPointHandler: CommandHandler<DeleteControlPointCommand> = {
  ...
  createUndo(command: DeleteControlPointCommand, context: CommandContext): EditorCommand | undefined {
    const controlPoint = context.controlPoints.getById(command.id);
    if (controlPoint) {
...
export const UpdateControlPointHandler: CommandHandler<UpdateControlPointCommand> = {
  ...
  merge(a: UpdateControlPointCommand, b: UpdateControlPointCommand, context: CommandContext): EditorCommand | undefined {
...
function setPendingInfo(controlPoint: ControlPoint, key: string, version: number) {
