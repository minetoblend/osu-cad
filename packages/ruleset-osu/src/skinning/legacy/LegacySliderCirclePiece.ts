...
export class LegacySliderCirclePiece extends CompositeDrawable
{
  ...
  protected override load(dependencies: ReadonlyDependencyContainer)
  {
    ...
    this.internalChildren = [
      this.circleSprite = new DrawableSprite({
        texture: this.skin.getTexture("sliderstartcircle") || this.skin.getTexture("hitcircle"),
        anchor: Anchor.Center,
        origin: Anchor.Center,
      }),
      this.overlaySprite = new DrawableSprite({
        texture: this.skin.getTexture("sliderstartcircleoverlay") || this.skin.getTexture("hitcircleoverlay"),
        anchor: Anchor.Center,
        origin: Anchor.Center,
      }),
