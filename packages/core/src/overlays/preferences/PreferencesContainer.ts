import type { ContainerOptions, Drawable, IKeyBindingHandler, KeyBindingPressEvent, KeyDownEvent, List, ReadonlyDependencyContainer, Vec2 } from '@osucad/framework';
import { Anchor, Axes, Bindable, Container, EasingFunction, Key } from '@osucad/framework';
...
export class PreferencesContainer
  ...
  #updateVisibility(visible: boolean) {
    if (visible) {
      ...
      this.#content.scaleTo(0.95, 400, EasingFunction.OutQuart);
