...
export class TimelineHitSound extends Container {
  ...
  update(hitSound: HitSound) {
    ...
    if (hitSound.additions) text += ':';
    if (hitSound.additions & Additions.Whistle) text += 'W';
    if (hitSound.additions & Additions.Finish) text += 'F';
    if (hitSound.additions & Additions.Clap) text += 'C';
