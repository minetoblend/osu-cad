        ...
        for (let i = 0; i < controlPoints.length; i++) {
          if (
            ...
            if (arcProperties.isValid) {
              positions.push(Object.assign(hitObject.position.add(arcProperties.centre), {
                draw: (g: Graphics) => {
                  console.log("draw");
            ...
            visibleHitObjectPositions.push(
              Object.assign(positions[i].add(rotated), {
                draw: (g: Graphics) => {
                  ...
                  const b2 = b.add(offset.rotate(Math.PI / 3 * 2).normalize().scale(radius));
                  const c2 = c.sub(offset.rotate(Math.PI / 3 * 2).normalize().scale(radius));
              ...
              Object.assign(positions[j].sub(rotated), {
                draw: (g: Graphics) => {
                  ...
                  const a2 = a.sub(offset.rotate(Math.PI / 3 * 2).normalize().scale(radius));
                  const c1 = c.add(offset.rotate(Math.PI / 3 * 2).normalize().scale(radius));
