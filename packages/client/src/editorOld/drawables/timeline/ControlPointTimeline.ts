...
import { MapContainer } from '@/editorOld/drawables/timeline/MapContainer.ts';
import { ControlPointMarker } from '@/editorOld/drawables/timeline/ControlPointMarker.ts';
