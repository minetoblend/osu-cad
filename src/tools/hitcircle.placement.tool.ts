import {ReceivePlayfieldMouseEvents, ToolWithOverlay} from "@/tools/tool";
...
export class HitcirclePlacementTool extends ToolWithOverlay<HitCirclePlacementOverlay> implements ReceivePlayfieldMouseEvents {
  ...
  onPlayfieldMouseDown(evt: OsuCadMouseEvent) {
    ...
    hitObject.time = this.context.currentTime.value
